...
import { CalendarDays, Clock, BookmarkPlus, Share2, MoreHorizontal, Twitter, Facebook, Linkedin } from 'lucide-react';
...
function SocialShareButtons({ post, url }: { post: BlogPost; url: string }) {
