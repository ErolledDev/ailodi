...
export function LatestInsights({ posts }: LatestInsightsProps) {
  ...
  return (
    <section id="latest-insights" className="py-16 sm:py-20 lg:py-24 bg-background transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">Fresh Tech Insights</h2>
